...
impl Theme {
    ...
    pub const CODE_BG: Color = Color::Rgb(26, 27, 38);          // #1a1b26 深色
    pub const CODE_KW: Color = Color::Rgb(187, 154, 247);       // #bb9af7 紫色
    pub const CODE_STR: Color = Color::Rgb(158, 206, 106);      // #9ece6a 绿色
    pub const CODE_FN: Color = Color::Rgb(122, 162, 247);       // #7aa2f7 蓝色
    pub const CODE_COMMENT: Color = Color::Rgb(86, 95, 137);    // #565f89 灰色
    ...
    pub const SELECTED: Color = Color::Rgb(122, 162, 247);      // #7aa2f7 蓝色
